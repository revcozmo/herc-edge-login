...
class TransactionSwiper extends Component {
    ...
    componentDidMount() {
        console.log(this.state.transactions, 'TransactionSwiper: state transactions')
...
export default connect(mapStateToProps)(TransactionSwiper);
